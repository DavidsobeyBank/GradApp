...
namespace GradApp.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        {
            var projects = db.Projects.Include(p => p.Area);
        ...
        public ActionResult Create([Bind(Include = "ProjectID,ProjectName,AreaID")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProjectID,ProjectName,AreaID")] Project project)
        {
            if (ModelState.IsValid)
            {
